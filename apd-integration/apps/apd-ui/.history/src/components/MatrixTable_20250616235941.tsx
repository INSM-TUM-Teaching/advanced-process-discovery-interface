...
const getInterpretation = (dependency: Dependency | undefined): any => {
    ...
    switch (existential_dependency.type) {
        case "Implication":
            existential_explanation = `There is an implication. Thus, whenever ${existential_dependency.direction == "Forward" ? dependency.from.toString().toUpperCase() : dependency.to
                } happens ${existential_dependency.direction == "Forward" ? dependency.to.toString().toUpperCase() : dependency.from.toString().toUpperCase()
        ...
        case "NegatedEquivalence":
            existential_explanation = `There is a negated equivalence. Thus, either ${dependency.from.toUpperCase
                } or ${dependency.to.toString().toUpperCase()
                } occurs.`
            break;
        case "Nand":
