...
const getInterpretation = (dependency: Dependency | undefined): any => {
    ...
    switch (existential_dependency.type) {
        case "Implication":
            existential_explanation = `There is an implication. Thus, whenever <b>${existential_dependency.direction == "Forward" ? dependency.from : dependency.to
                }</b> happens ${existential_dependency.direction == "Forward" ? dependency.to : dependency.from
