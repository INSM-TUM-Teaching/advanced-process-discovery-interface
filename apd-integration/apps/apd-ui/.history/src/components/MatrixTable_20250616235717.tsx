...
const getInterpretation = (dependency: Dependency | undefined): any => {
    ...
    if (temporal_dependency.type == "Direct")
        temporal_explanation = `There is a direct temporal dependency. Thus, a termination of ${temporal_dependency.direction == "Forward" ? dependency.from.toUpperCase : dependency.to
